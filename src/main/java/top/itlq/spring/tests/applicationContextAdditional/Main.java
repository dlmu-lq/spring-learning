...
public class Main {
    ...
    void testMessageSource(){
        MessageSource messageSource = new ClassPathXmlApplicationContext("applicationContextAdditional/message-source-test.xml");
    ...
    void testReloadMessageSource() throws Exception{
        MessageSource messageSource = new ClassPathXmlApplicationContext("applicationContextAdditional/beans.xml");
